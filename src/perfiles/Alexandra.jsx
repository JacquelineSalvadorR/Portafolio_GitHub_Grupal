...
import {
  FaReact, FaDatabase, FaHtml5, FaShieldAlt,
...
const Alexandra = () => {
  ...
  return (
    <motion.div
      ...
      style={{
        background: "linear-gradient(to right,rgb(204, 144, 228),rgb(164, 238, 222))",
        minHeight: '100vh',
        width: '100%',
        margin: 0,
        padding: 0,
    ...
    >
      <Container className="text-center my-5">
        <img src={fotoAlexandra} alt="Alexandra Tipacti" className="perfil-foto" />
