const portfolioData = [
  {
    info: {
      ...
      fondo: { color1: '#cc99a9', color2: '#d1b77f' }
    },
  ...
  },
  {
    info: {
      ...
      description: 'Soy Técnico en Computación con un fuerte enfoque en el desarrollo backend y frontend, apasionado por crear aplicaciones web modernas y escalables. Actualmente, estoy ampliando mis conocimientos hacia el rol de DevOps o SRE, explorando tecnologías para la automatización de despliegues y la administración de infraestructuras robustas.',
      fondo: { color1: '#0f2027', color2: '#2c5364' }
    },
    ...
    projects: [
      ...
      },
      {
        id: 5,
        title: 'Proyecto 5',
        description: 'Configuración de Servidores Linux.',
  ...
  },
  {
    info: {
      ...
      description: 'Soy Técnico en Telecomunicaciones y estudiante de Ingeniería de Sistemas e Informática. Me interesa el desarrollo de software, la inteligencia artificial, la ciberseguridad y la infraestructura de telecomunicaciones.',
      fondo: { color1: '#ff9966', color2: '#ff5e62' }
    },
    ...
    projects: [
      {
        id: 1,
        title: 'Proyecto 1',
        description: 'Proyecto de telecomunicaciones.',
        image: require('../assets/img/e1.jpg')
      },
      {
        id: 2,
        title: 'Proyecto 2',
        description: 'Instalación de redes y seguridad.',
        image: require('../assets/img/e2.jpg')
      },
      {
        id: 3,
        title: 'Proyecto 3',
        description: 'Simulación de redes virtuales.',
  ...
  },
  {
    info: {
      ...
      description: 'Soy una apasionada estudiante de Ingeniería de Sistemas, con interés en el desarrollo de software, la inteligencia artificial y la ciberseguridad. Me encanta crear soluciones tecnológicas innovadoras, mejorar la eficiencia de los procesos y seguir aprendiendo sobre nuevas tecnologías.',
      fondo: { color1: '#b24592', color2: '#f15f79' }
    },
    ...
    projects: [
      ...
      },
      {
        id: 2,
        title: 'Proyecto 2',
        description: 'Simulación de sistema bancario.',
  ...
  },
  {
    info: {
      ...
      fondo: { color1: '#43cea2', color2: '#185a9d' }
    },
    skills: ['HTML', 'CSS', 'C#'],
    projects: [
      {
        id: 1,
        title: 'Proyecto 1',
        description: 'Diseño de página web corporativa.',
